package com.wistron.web.registry;
...
public class JspRegistry implements ApplicationContextAware,
	...
	public void init() {
		...
		initparams.put("usePrecompiled", "false");
		
		JspServlet jspServlet = new JspServlet(bundleContext.getBundle(), "/WebContent/jsp", "/teacher/jsp");
		try {
			httpService.registerServlet("/teacher/jsp", jspServlet, initparams, commonContext);
