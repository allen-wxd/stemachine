...
public class JspRegistry implements ApplicationContextAware,
	...
	public void init() {
		...
		initparams.put("usePrecompiled", "true");
		
		JspServlet jspServlet = new JspServlet(bundleContext.getBundle(), "/WebContent/jsp", "/login");
		try {
			httpService.registerServlet("/login", jspServlet, initparams, commonContext);
